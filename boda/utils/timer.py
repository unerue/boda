...
class Timer:
    ...
    def __enter__(self):
        print('#'*10, self.name, Timer._total_time)
        return self
...
#         self.func = func
#         # self._start_times = defaultdict(lambda: -1)

#     def reset_all(self):
#         pass

#     def register(self, func):
#         Timer._registry.append(func)

#     def __call__(self, *argv, **kwargs):
#         print(self.func.__name__)
#         # start_time = datetime.datetime.now()
#         res = self.func(*argv, **kwargs)
#         print((time.time() - self._total_time), '\n')
#         return res 
